...
import com.yongyida.robot.settings.utils.DataUtil;
...
public class VersionControl {
	...
	public static int mDownloadBg = R.drawable.qrcode_xy; // 下载app二维码的背景图
	public static int mDownloadTip = R.string.scan_dev; 
	
	public static int mBindBg = R.drawable.qrcode_yyd;// 绑定机器人二维码的背景图
	...
	private static void setVersionDev() {	
		...
		mDownloadBg = R.drawable.qrcode_xy; // 下载app二维码的背景图
		mDownloadTip = R.string.scan_dev; 	
		mBindBg = R.drawable.qrcode_yyd;// 绑定机器人二维码的背景图
	...
	private static void setVersionSt() {
		...
		mDownloadBg = R.drawable.qrcode_st; // 下载app二维码的背景图
		mDownloadTip = R.string.scan_st; 	
		mBindBg = R.drawable.qrcode_st;// 绑定机器人二维码的背景图
	...
	private static void setVersionCmcc() {	
		...
		mDownloadBg = R.drawable.qrcode_cmcc; // 下载app二维码的背景图
		mDownloadTip = R.string.scan_cmcc; 	
		mBindBg = R.drawable.qrcode_cmcc;// 绑定机器人二维码的背景图
